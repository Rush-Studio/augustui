import SwipeFlicker from "../augustui/swipe-flicker";

export default function SwipeFlickerDemo() {
  const images = [
  ...
  return (
    <div className="relative size-full">
      ...
      <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center gap-1 text-center text-white">
        ...
        <p className="drop-shadow-md">Just swipe your cursor and proceed</p>
      </div>
    </div>
  );
}
