...
export default async function DocPage({ params }: DocPageProps) {
  ...
  return (
    <main className="relative lg:gap-10 xl:grid xl:grid-cols-[1fr_300px]">
      <div className="mx-auto w-full min-w-0 max-w-3xl px-2 py-6 md:px-0 lg:py-8">
      ...
      {doc.toc && (
        <div className="hidden border-l border-border py-6 pl-6 text-sm lg:py-8 xl:block">
          <div className="sticky top-14 -mt-10 h-[calc(100vh-3.5rem)] space-y-4 py-12">
